...
function addsym(){
    var addHtml = '<div class=" addsymptom"> '+
                        '<div class="row">'+
                        ...
                        '       <td></td>'+
                                    ...
                                    '   <tr>'+
                                    '       <td>weight:</td>'+
                                    '        <td> <input type="number" placeholder="Weight" class="form-control  input-group-lg"  name="weight" id="weight"></td>'+
                                    '     </tr>'+
                                    '      <tr>'+
                                    '          <td></td>'+
...
{
			var name = '<div class=" vertical-gap sym_header"><h2>'+(no+1)+'. '+sname+'</h2><input class="form-control  input-group-lg" placeholder="Description" id="des'+no+'"></div>';
			var tuple1 = '<td><input type="text" class="form-control  input-group-lg" id="'
			var tuple22 = '"></td><td><input type="text" onchange="update_start_of_next_range(this)" class="form-control  input-group-lg" id="'
			...
			$('#disease_info').append(name+tb1+s+tb2);
			no++;
}
...
function f3(sname,rows)
{
	...
	var tuple1 = '<td><input type="text" class="form-control input-group-lg" id="'
	var tuple2 = '"></td><td><select class="form-control input-group-lg" name="cars" id="'
	var tuple3 = '"><option value="1">Yes</option><option value="2">May Be</option><option value="3">No</option></select></td>'
...
{
	if (confirm("Do you want to submit new disease")) {
	 $.ajax({
    	url   : "../doctor/add_to_db.php",
    	type  : "POST",
    	async : false,
    	data  : {
				  "str" : str ,
...
// When the user clicks the button, open the modal 
    		...
    		//alert																																																																																																																																																																									$("#modal_button").click();
			window.location.href ="../doctor/listdis.php"
