...
require "../config.php";
  ...
  for ($i=0; $i < sizeof($st); $i++) { 
      ...
      $q2 = "Select * from symptom where s_name='".$sname."'";
...
function all_dis($con,$hm, $did )
  {
    $main_arr = [];
    $q1 = "Select * from disease where did='$did'";
  	...
  	while($row = $res->fetch_array())
    {
      ...
      while($row2 = $res2->fetch_array())
      {
          ...
          $dis_arr[$fvar[$hm[$row2['s_id']]]] += $row2['weight'];
                    //1,2,3 -->yes,maybe,no
      }
